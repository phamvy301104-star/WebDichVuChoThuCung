...
const NAV_SECTIONS: NavSection[] = [
  ...
  {
    title: "THÚ CƯNG",
    items: [{ to: "/admin/pets", icon: "🐾", label: "Quản lý thú cưng" }],
  },
  {
    title: "TÀI KHOẢN",
    items: [
  ...
  {
    title: "MARKETING",
    items: [{ to: "/admin/promotions", icon: "🎁", label: "Khuyến mãi" }],
  },
  {
    title: "BÁO CÁO",
    items: [{ to: "/admin/reports", icon: "📊", label: "Báo cáo" }],
  },
  {
    title: "HỖ TRỢ",
    items: [{ to: "/admin/contact", icon: "💬", label: "Liên hệ", badge: 6 }],
  },
  {
    title: "CÀI ĐẶT",
    items: [{ to: "/admin/settings", icon: "⚙️", label: "Cài đặt liên hệ" }],
  },
];
      ...
      <nav className="asn-nav">
        {NAV_SECTIONS.map((section) => (
          <div key={section.title} className="asn-section">
            {!collapsed && (
              <div className="asn-section-title">{section.title}</div>
            )}
