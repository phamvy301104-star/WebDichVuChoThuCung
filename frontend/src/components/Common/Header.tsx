    ...
    <header className="header">
      <div className="header-container">
        ...
        <div className="header-actions">
          <Link to="/cart" className="cart-icon" title="Giỏ hàng" style={{ position: 'relative' }}>
            🛒
            {cartCount > 0 && (
              <span style={{ position: 'absolute', top: -6, right: -6, background: '#ef4444', color: '#fff', fontSize: '0.65rem', fontWeight: 800, minWidth: 18, height: 18, borderRadius: 9, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 4px' }}>
                {cartCount}
              </span>
            )}
          </Link>
