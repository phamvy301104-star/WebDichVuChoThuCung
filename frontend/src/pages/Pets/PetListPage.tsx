...
const MOCK_PETS: Partial<Pet>[] = [
  { _id: 'p1', name: 'Max', species: 'Chó', breed: 'Golden Retriever', age: 3, gender: 'male', image: 'https://images.unsplash.com/photo-1601979031925-424e53b6caaa?w=400&h=300&fit=crop&auto=format', description: 'Max rất thân thiện, hiền lành và thích trẻ em. Đã tiêm phòng đầy đủ.', status: 'available', listingType: 'adoption', price: 0 },
  { _id: 'p2', name: 'Bella', species: 'Mèo', breed: 'Maine Coon', age: 1, gender: 'female', image: 'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=400&h=300&fit=crop&auto=format', description: 'Bella lanh lợi, hay nghịch ngợm nhưng rất dễ thương và tình cảm.', status: 'available', listingType: 'adoption', price: 0 },
  { _id: 'p3', name: 'Buddy', species: 'Chó', breed: 'Corgi', age: 1, gender: 'male', image: 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=400&h=300&fit=crop&auto=format', description: 'Buddy năng động, thích chạy nhảy và học các trò mới rất nhanh.', status: 'available', listingType: 'sale', price: 5000000 },
  { _id: 'p4', name: 'Whiskers', species: 'Mèo', breed: 'Ba Tư', age: 4, gender: 'male', image: 'https://images.unsplash.com/photo-1526336024174-e58f5cdd8e13?w=400&h=300&fit=crop&auto=format', description: 'Whiskers điềm tĩnh, hợp với gia đình có không gian yên tĩnh.', status: 'rescue', listingType: 'adoption', price: 0 },
  { _id: 'p5', name: 'Coco', species: 'Thỏ', breed: 'Holland Lop', age: 1, gender: 'female', image: 'https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308?w=400&h=300&fit=crop&auto=format', description: 'Coco cực kỳ đáng yêu, hiền, không gây ồn. Phù hợp căn hộ.', status: 'available', listingType: 'sale', price: 1200000 },
  { _id: 'p6', name: 'Luna', species: 'Mèo', breed: 'Exotic Shorthair', age: 2, gender: 'female', image: 'https://images.unsplash.com/photo-1571566882372-1598d88abd90?w=400&h=300&fit=crop&auto=format', description: 'Luna béo tròn, lười biếng theo kiểu đáng yêu, thích được âu yếm.', status: 'available', listingType: 'adoption', price: 0 },
  { _id: 'p7', name: 'Rocky', species: 'Chó', breed: 'Husky', age: 2, gender: 'male', image: 'https://images.unsplash.com/photo-1605568427561-40dd23c2acea?w=400&h=300&fit=crop&auto=format', description: 'Rocky năng động, trung thành, lông dày đẹp. Cần không gian rộng.', status: 'available', listingType: 'sale', price: 8000000 },
  { _id: 'p8', name: 'Milo', species: 'Chó', breed: 'Poodle', age: 1, gender: 'male', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=300&fit=crop&auto=format', description: 'Milo nhỏ nhắn, thông minh, không rụng lông. Phù hợp mọi gia đình.', status: 'available', listingType: 'sale', price: 6500000 },
];
